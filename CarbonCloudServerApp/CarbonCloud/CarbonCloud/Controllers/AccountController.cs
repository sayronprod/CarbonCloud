    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Delete(DeleteAccountModel userPass)
        {
            ...
            {               
                ...
                FileProvider.DeleteFolderOrFile(User.Identity.GetUserId(),true);
                return Ok();
            }
        ...
        public async Task<UserInfoModel> GetInfo()
        {
            ...
            return new UserInfoModel { Email = user.Email, Name = user.DisplayName };
        }
        // POST api/Account/SentCode
        [AllowAnonymous]
        [Route("SentCode")]
        public async Task<IHttpActionResult> SentCode(SentingCodeModel Code)
        {
            //EmailProvider.SentCodeToEmail("cool.sirion@gmail.com", Directory.GetCurrentDirectory());
            try
            {
                ...
                if (Code.code == user.codefromemail.ToString())
                {
                    ...
                    FileProvider.CreateFolderForNewUser(user.Id);
            ...
            {
                EmailProvider.SentCodeToEmail("cool.sirion@gmail.com", e.ToString());
            }
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            try
            {
                ...
                user = new ApplicationUser() { Email = model.Email, DisplayName = model.Name, codefromemail = code, UserName = model.Email };
